...
class Metaclass_MoveToPose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('moveit_wrapper')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from moveit_wrapper.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from moveit_wrapper.srv._move_to_pose import MoveToPose_Request as Request
    from moveit_wrapper.srv._move_to_pose import MoveToPose_Response as Response
